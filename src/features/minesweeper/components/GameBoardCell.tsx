...
export function GameBoardCell({ id }: Props) {
  ...
  switch (state) {
    ...
    case CellState.MINE_REVEALED:
      return <div className={gameboardCell}><BombIcon /></div>;
    case CellState.MINE_EXPLODED:
      return <div className={gameboardCell}>
        <BombIcon />
      </div>;
